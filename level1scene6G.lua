...
function scene:createScene( event )
	...
	local back = widget.newButton { defaultFile = "images/back2.png", overFile ="images/back2.png", id = "back", x = _W/30, y = _H - _H/10,
	...
	local sheetOptions = { width = 576, height = 320, numFrames = 4 }

	local sheet1 = graphics.newImageSheet( "images/level1/imgsheet3.png", sheetOptions )
	
	local sequence= { { name = "normalRun", start = 1, count = 4, time = 16000, loopCount = 1, loopDirection = "forward" } }
