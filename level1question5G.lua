...
local function buttonOnRelease(event)
	local button = event.target.id
		if button == "back" then
			storyboard.purgeScene( "level1scene5G", false )
...
function scene:createScene(event )
	...
	local images = {"images/"..gameSettings.lang.."/"..gameSettings.character.."/level1/scene30.jpg", "images/"..gameSettings.lang.."/"..gameSettings.character.."/level1/scene17.jpg"}
	local randomImages = {}
