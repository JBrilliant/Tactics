	...
	if gameSettings.soundOn == true then
		local button = event.target.id
			...
			elseif button == "choice2" then
				...
				else audio.play( sfx.correct_answer, { loops = 0, channel = 29, onComplete = function()  audio.dispose(29)  end } ) end
...
function scene:createScene( event )
	...
	elseif gameSettings.lang == "tagalog" then
		...
		elseif curLvl == 3 then text = {"Pabayaan ito at ipagpatuloy ang paglalaro", "Ipagpatuloy ang paglalaro at \nsabihan itong tumahimik", "Umiyak dahil nakakasakit ito ng damdamin"}
