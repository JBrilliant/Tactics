...
--	transition.to( background, {alpha=0,time=3000, delay=2000 } )
	...
	local function txt()
		local animation1 = transition.to(textQuest,{ time=1000, y = _H/2, xScale=2, yScale=2,
	...
	local function choice1fn()
		...
		local choice1 = widget.newButton { defaultFile = "images/level1/scene24.jpg", id = "choice1", x = _W/2 , y = _H/2 , height =   _H/4 + 30, width = _W/3 + 30, onRelease = buttonOnRelease }	
	...
	local function choice2fn()
		local choice2 = widget.newButton { defaultFile = "images/level1/scene25.jpg", id = "choice2", x = _W/2, y = _H/2 , height =  _H/4 + 30, width = _W/3 + 30, onRelease = buttonOnRelease }
