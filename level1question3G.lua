...
function scene:createScene( event )
	...
	local textQuest =  display.newText( "What will you say?", 270, 10, native.systemFontBold, 24 ); textQuest.x = _W/2; textQuest.y = _H/5; textQuest:setFillColor( 1,1,1 )
	...
	local images = {"images/level1/scene24.jpg", "images/level1/scene25.jpg"}
	local randomImages = {}
