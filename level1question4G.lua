...
--	transition.to( background, {alpha=0,time=3000, delay=2000 } )
	...
	local function choice1fn()
		...
		local choice1 = widget.newButton { defaultFile = "images/level1/scene16.jpg", id = "choice1", x = _W/2 , y = _H/2 , height =   _H/4 + 30, width = _W/3 + 30, onRelease = buttonOnRelease }	
	...
	local function choice2fn()
		...
		local animation = transition.to(choice2,{ time=2000,  x=_W/2 +10, y = _W/2-100, xScale=9.5, yScale=9.5,
				transition=easing.inQuad,customProperty=1000,onComplete=after})
		transition.to(choice2,{time=1000,delay=4000, x=_W - _W/4, y = _H/2,  xScale=1, yScale=1, transition=easing.inQuad})		
