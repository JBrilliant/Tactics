...
local function buttonOnRelease(event)
	local button = event.target.id
		...
		elseif button == "choice1" then
			...
			-- if curLvl == 1 then	storyboard.purgeScene( "level1question1G", false ); storyboard.gotoScene( "level1scene2G", "fade", 200 )
			if curLvl == 3 then storyboard.purgeScene( "level1question1G", false ); storyboard.gotoScene( "level1scene4G", "fade", 200 ) end
		elseif button == "choice2" then
			...
			if curLvl == 3 then storyboard.purgeScene( "level1question1G", false ); storyboard.gotoScene( "level1scene5G", "fade", 200 ) end
		elseif button == "choice3" then
			energyM.minus(); energyM.save(); gameSettings.levels[curLvl].energy = energyM.get(); loadsave.saveTable(gameSettings, "myTable.json", system.DocumentsDirectory); loadsave.printTable(gameSettings)
			-- if curLvl == 1 then storyboard.purgeScene( "level1question1G", false ); storyboard.gotoScene( "level1scene4G", "fade", 200 )
