...
local function buttonOnRelease(event)
	local button = event.target.id
		if button == "back" then
			...
			storyboard.purgeScene( "level1scene2G", false )
...
function scene:createScene( event )
	...
	local images = {"images/"..gameSettings.lang.."/"..gameSettings.character.."/level1/scene2a.jpg", "images/"..gameSettings.lang.."/"..gameSettings.character.."/level1/scene1b.jpg"}
	local randomImages = {}
